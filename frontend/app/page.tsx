...
import { Activity, ArrowDownCircle, ArrowUpCircle, FileSpreadsheet, PlusCircle, Trash, TrendingDown, TrendingUp, Wallet } from "lucide-react";
      ...
      <dialog id="my_modal_3" className="modal backdrop-blur">
        <div className="modal-box border-2 border-warning/10 border-dashed">
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="flex flex-col gap-2 mt-4">
              <label className="label">Montant(négatif - dépense, positif + revenus)</label>
              <input
                type="number"
                name="amount"
                value={amount}
